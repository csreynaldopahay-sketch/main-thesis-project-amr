...
def main():
    ...
    data_path = args.data or project_root / 'data' / 'processed' / 'encoded_dataset.csv'
    output_path = args.output or project_root / 'docs' / 'results' / 'threshold_sensitivity_report.md'
