...
def main():
    ...
    data_path = args.data or project_root / 'data' / 'processed' / 'cleaned_dataset.csv'
    output_path = args.output or project_root / 'docs' / 'results' / 'encoding_sensitivity_report.md'
    ...
    # Run analysis
    results = run_encoding_sensitivity_analysis(df, n_clusters=args.k)
