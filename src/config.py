...
RAW_DATA_DIR = PROJECT_ROOT  # Raw CSVs are in project root
...
CLUSTERING_CONFIG = {
    ...
    'default_n_clusters': 5,  # Default only; should be determined by elbow/silhouette
    'min_k': 3,  # Minimum clusters to test
    'max_k': 10,  # Maximum clusters to test
    'preferred_k': 5,  # Preferred k when near elbow
    'silhouette_threshold': 0.40,  # Minimum silhouette for "strong" clustering
...
if __name__ == "__main__":
    ...
    print(f"Default k: {CLUSTERING_CONFIG['default_n_clusters']}")
